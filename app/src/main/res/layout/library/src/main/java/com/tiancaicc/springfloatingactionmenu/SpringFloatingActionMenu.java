package layout.library.src.main.java.com.tiancaicc.springfloatingactionmenu;
...
public class SpringFloatingActionMenu extends FrameLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private ArrayList<com.tiancaicc.springfloatingactionmenu.MenuItem> mMenuItems;

    private ArrayList<ImageButton> mFollowCircles;

    private ArrayList<com.tiancaicc.springfloatingactionmenu.MenuItemView> mMenuItemViews;

    private ViewGroup mContainerView;

    private ArrayList<com.tiancaicc.springfloatingactionmenu.OnMenuActionListener> mActionListeners;

    private com.tiancaicc.springfloatingactionmenu.OnFabClickListener mOnFabClickListener;
    ...
    private void init(Context context) {
        ...
        for (com.tiancaicc.springfloatingactionmenu.MenuItemView menuItemView : mMenuItemViews) {
...
//        addView(mContainerView);
        //add FAB
        LayoutParams fablp = com.tiancaicc.springfloatingactionmenu.Utils.createWrapParams();
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int bottomInsets = com.tiancaicc.springfloatingactionmenu.Utils.getInsetsBottom(context, this);

        int fabX = 0;
        int fabY = 0;
        if (mGravity == (Gravity.BOTTOM | Gravity.RIGHT)) {
            int marginX = com.tiancaicc.springfloatingactionmenu.Utils.dpToPx(mMarginSize, resources);
            int marginY = com.tiancaicc.springfloatingactionmenu.Utils.dpToPx(mMarginSize, resources) + bottomInsets;
    ...
    private ArrayList<ImageButton> generateFollowCircles() {
        ...
        int diameter = mFAB.getType() == FloatingActionButton.TYPE_NORMAL ?
                com.tiancaicc.springfloatingactionmenu.Utils.getDimension(mContext, com.tiancaicc.springfloatingactionmenu.R.dimen.fab_size_normal) :
                com.tiancaicc.springfloatingactionmenu.Utils.getDimension(mContext, com.tiancaicc.springfloatingactionmenu.R.dimen.fab_size_mini);
    ...
    private ArrayList<com.tiancaicc.springfloatingactionmenu.MenuItemView> generateMenuItemViews() {
        ArrayList<com.tiancaicc.springfloatingactionmenu.MenuItemView> menuItemViews = new ArrayList<>(mMenuItems.size());
        for (com.tiancaicc.springfloatingactionmenu.MenuItem item : mMenuItems) {
...
//            menuItemView.setOnClickListener(item.getOnClickListener());
    ...
    private View generateRevealCircle() {
        int diameter = mFAB.getType() == FloatingActionButton.TYPE_NORMAL ?
                com.tiancaicc.springfloatingactionmenu.Utils.getDimension(mContext, com.tiancaicc.springfloatingactionmenu.R.dimen.fab_size_normal) :
                com.tiancaicc.springfloatingactionmenu.Utils.getDimension(mContext, R.dimen.fab_size_mini);
    ...
    private void addOnMenuActionListener(com.tiancaicc.springfloatingactionmenu.OnMenuActionListener listener) {
    ...
    public void showMenu() {
        ...
        hideFollowCircles();
        revealIn();
        for (com.tiancaicc.springfloatingactionmenu.OnMenuActionListener listener : mActionListeners) {
            listener.onMenuOpen();
        }
        mMenuOpen = !mMenuOpen;
    }
    ...
    private void applyBloomOpenAnimation() {
        ...
        for (int i = 0; i < mMenuItemCount; i++) {
            ...
            com.tiancaicc.springfloatingactionmenu.MenuItemView menuItemView = mMenuItemViews.get(i);
    ...
    public static class Builder {
        ...
        private ArrayList<com.tiancaicc.springfloatingactionmenu.MenuItem> menuItems = new ArrayList<>();
        ...
        private com.tiancaicc.springfloatingactionmenu.OnFabClickListener onFabClickListener;

        private ArrayList<com.tiancaicc.springfloatingactionmenu.OnMenuActionListener> actionListeners = new ArrayList<>();
        ...
        public Builder addMenuItem(@ColorRes int bgColor, int icon, String label,
            ...
            menuItems.add(new com.tiancaicc.springfloatingactionmenu.MenuItem(bgColor, icon, label, textColor, onClickListener));
            return this;
        }
